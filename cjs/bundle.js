...
exports.hmacSha512 = exports.hmacSha256 = exports.ed25519Verify = exports.ed25519Sign = exports.ed25519KeypairFromSeed = exports.dilithium2Verify = exports.dilithium2Sign = exports.dilithium2KeypairFromSeed = void 0;
...
const dilithium2KeypairFromSeed = withWasm((wasm, seed) => {
  wasm.ext_dilithium_from_seed(8, ..._init.bridge.allocU8a(seed));
  return _init.bridge.resultU8a();
});
exports.dilithium2KeypairFromSeed = dilithium2KeypairFromSeed;
const dilithium2Sign = withWasm((wasm, pubkey, seed, message) => {
  wasm.ext_dilithium_sign(8, ..._init.bridge.allocU8a(pubkey), ..._init.bridge.allocU8a(seed), ..._init.bridge.allocU8a(message));
  return _init.bridge.resultU8a();
});
exports.dilithium2Sign = dilithium2Sign;
const dilithium2Verify = withWasm((wasm, signature, message, pubkey) => {
  const ret = wasm.ext_dilithium_verify(..._init.bridge.allocU8a(signature), ..._init.bridge.allocU8a(message), ..._init.bridge.allocU8a(pubkey));
  return ret !== 0;
});
