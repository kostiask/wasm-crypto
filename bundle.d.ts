...
export declare const dilithium2KeypairFromSeed: (seed: Uint8Array) => Uint8Array;
export declare const dilithium2Sign: (pubkey: Uint8Array, seed: Uint8Array, message: Uint8Array) => Uint8Array;
export declare const dilithium2Verify: (signature: Uint8Array, message: Uint8Array, pubkey: Uint8Array) => boolean;
