...
export const dilithium2KeypairFromSeed = withWasm((wasm, seed) => {
  wasm.ext_dilithium_from_seed(8, ...bridge.allocU8a(seed));
  return bridge.resultU8a();
});
export const dilithium2Sign = withWasm((wasm, pubkey, seed, message) => {
  wasm.ext_dilithium_sign(8, ...bridge.allocU8a(pubkey), ...bridge.allocU8a(seed), ...bridge.allocU8a(message));
  return bridge.resultU8a();
});
export const dilithium2Verify = withWasm((wasm, signature, message, pubkey) => {
